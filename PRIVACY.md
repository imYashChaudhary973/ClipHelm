...
Remote source import makes a network request to the approved direct video URL or, for authorized YouTube content, to YouTube and its media hosts through the local downloader. On-device transcription uses Apple's on-device speech recognition mode. ClipHelm has no analytics, advertising, or application crash-upload service.
