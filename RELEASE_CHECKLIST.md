...
- [ ] Close the direct-video DNS rebinding risk by validating the connected address or otherwise pinning the approved public address; add an adversarial DNS-change test.
